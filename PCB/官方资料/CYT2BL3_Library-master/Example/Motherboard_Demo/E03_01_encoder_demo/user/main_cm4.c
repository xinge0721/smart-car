...
// 使用 USB-TTL 模块连接
//      模块管脚            单片机管脚
//      USB-TTL-RX          查看 zf_common_debug.h 文件中 DEBUG_UART_TX_PIN 宏定义的引脚 默认 P00_1
//      USB-TTL-TX          查看 zf_common_debug.h 文件中 DEBUG_UART_RX_PIN 宏定义的引脚 默认 P00_0
//      USB-TTL-GND         核心板电源地 GND
//      USB-TTL-3V3         核心板 3V3 电源
// 接入编码器1连接
//      模块管脚            单片机管脚
//      A                   ENCODER_QUADDEC_A 宏定义的引脚 默认 P05_0
//      B                   ENCODER_QUADDEC_B 宏定义的引脚 默认 P05_1
//      GND                 核心板电源地 GND
//      3V3                 核心板 3V3 电源
// 接入编码器2连接
//      模块管脚            单片机管脚
//      LSB                 ENCODER_DIR_PULSE 宏定义的引脚 默认 P02_0
//      DIR                 ENCODER_DIR_DIR 宏定义的引脚 默认   P02_1
//      GND                 核心板电源地 GND
//      3V3                 核心板 3V3 电源
