...
// 接入 imu660ra
//      模块管脚            单片机管脚
//      SCL/SPC             查看 zf_device_imu660ra.h 中 imu660ra_SPC_PIN 宏定义 默认 P14_2
//      SDA/DSI             查看 zf_device_imu660ra.h 中 imu660ra_SDI_PIN 宏定义 默认 P14_1
//      SA0/SDO             查看 zf_device_imu660ra.h 中 imu660ra_SDO_PIN 宏定义 默认 P14_0
//      CS                  查看 zf_device_imu660ra.h 中 imu660ra_CS_PIN  宏定义 默认 P18_0
//      GND                 电源地 GND
//      3V3                 电源 3V3
...
// **************************** 代码区域 ****************************
#define LED1                    (P23_7)                                         // 单排排针 SPI 两寸屏 这里宏定义填写 IPS200_TYPE_SPI
