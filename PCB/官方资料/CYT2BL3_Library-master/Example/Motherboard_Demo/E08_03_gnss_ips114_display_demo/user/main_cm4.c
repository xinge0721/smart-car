...
//      RES                 查看 zf_device_ips114.h 中 ips114_RES_PIN 宏定义 默认 P15_1
//      DC                  查看 zf_device_ips114.h 中 ips114_DC_PIN  宏定义 默认 P15_0
//      CS                  查看 zf_device_ips114.h 中 ips114_CS_PIN  宏定义 默认 P15_2
//      BL                  查看 zf_device_ips114.h 中 ips114_BL_PIN  宏定义 默认 P15_4
//      GND                 核心板电源地 GND
//      3V3                 核心板 3V3 电源
...
int main(void)
{
    ...
    while(true)
    {
        ...
        if(gnss_flag)
        {
            ...
            ips114_show_uint(  160, 16*2, gnss.state, 5);
            ips114_show_float( 0, 16*2, gnss.latitude, 4, 6);
            ips114_show_float( 0, 16*3, gnss.longitude, 4, 6);
            ips114_show_float( 0, 16*4, (double)gnss.speed, 4, 6);
            ips114_show_float( 0, 16*5, (double)gnss.direction, 4, 6);
            ips114_show_uint(  0, 16*6, gnss.satellite_used, 5);
            ips114_show_float( 0, 16*7, (double)gnss.height, 4, 6);
        }
        else
        {
            no_data_count ++;
