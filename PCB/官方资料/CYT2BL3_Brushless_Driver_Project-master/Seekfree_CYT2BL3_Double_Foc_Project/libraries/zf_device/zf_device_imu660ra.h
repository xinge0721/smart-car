...
#define IMU660RA_SCL_PIN              (P14_2)                                  // 软件 IIC SCL 引脚 连接 IMU660RA 的 SCL 引脚
#define IMU660RA_SDA_PIN              (P14_1)                                  // 软件 IIC SDA 引脚 连接 IMU660RA 的 SDA 引脚
//====================================================软件 IIC 驱动====================================================
#else
//====================================================硬件 SPI 驱动====================================================
#define IMU660RA_SPI_SPEED            (10 * 1000 * 1000)                        // 硬件 SPI 速率
#define IMU660RA_SPI                  (SPI_4           )                         // 硬件 SPI 号
#define IMU660RA_SPC_PIN              (SPI4_CLK_P14_2  )                        // 硬件 SPI SCK 引脚
#define IMU660RA_SDI_PIN              (SPI4_MOSI_P14_1 )                        // 硬件 SPI MOSI 引脚
#define IMU660RA_SDO_PIN              (SPI4_MISO_P14_0 )                        // 硬件 SPI MISO 引脚
//====================================================硬件 SPI 驱动====================================================
#endif
#define IMU660RA_CS_PIN               (P11_0)                                   // CS 片选引脚
