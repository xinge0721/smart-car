...
#define ABSOLUTE_ENCODER_SCLK_PIN           (SPI2_CLK_P07_2 )                   // 硬件 SPI SCK 引脚
#define ABSOLUTE_ENCODER_MOSI_PIN           (SPI2_MOSI_P07_1)                   // 硬件 SPI MOSI 引脚
#define ABSOLUTE_ENCODER_MISO_PIN           (SPI2_MISO_P07_0)                   // 硬件 SPI MISO 引脚
//====================================================硬件 SPI 驱动====================================================
#endif

#define ABSOLUTE_ENCODER_CS_PIN             (P11_0)                             // CS引脚定义
