...
{
    if(exti_flag_get(LEFT_MOTOR_HALL_A_PIN))		
    {

        motor_left_hall_callback();
            
    }
    if(exti_flag_get(LEFT_MOTOR_HALL_B_PIN))
    {

        motor_left_hall_callback();    
            
    }
    if(exti_flag_get(LEFT_MOTOR_HALL_C_PIN))
    {
...
{
    if(exti_flag_get(RIGHT_MOTOR_HALL_A_PIN))		
    {

        motor_right_hall_callback();
            
    }
    if(exti_flag_get(RIGHT_MOTOR_HALL_B_PIN))
    {

        motor_right_hall_callback();    
            
    }
    if(exti_flag_get(RIGHT_MOTOR_HALL_C_PIN))
    {
